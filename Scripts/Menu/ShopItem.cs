...
namespace WoCo.DungeonCrawler {
	...
	// 
	// ===================================================================================
    public class ShopItem : ShopBase<TemplateItem> {
        ...
        protected override void LoadContent() {
            ...
            content = DictionaryItem.dict.Values.Where(x => x.ShopListingRequirementsMet(parent.shop) && x.tradeCost.currencyType == parent.shop.currencyType && (x is TemplateItemAttack || x is TemplateItemSpecial) )
